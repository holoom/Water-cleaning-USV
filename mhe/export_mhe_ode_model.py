...
def export_mhe_model(params):
    model_name = 'otter_mhe'
    ...
    v_dot = SX.sym('v_dot')
    r_dot = SX.sym('r_dot')
    added_mass_x_dot = SX.sym('added_mass_x_dot')
    linear_d_x_dot = SX.sym('linear_d_x_dot')
